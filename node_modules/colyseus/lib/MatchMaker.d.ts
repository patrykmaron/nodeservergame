...
export declare class MatchMaker {
    ...
    protected isGracefullyShuttingDown: boolean;
    bindClient(client: Client, roomId: string): Promise<Room<any>>;
    protected execute(client: Client, message: any): void;
    /**
     ...
     */
    onJoin(roomId: string, client: Client): Promise<Room>;
    onLeave(client: Client, roomId: string): void;
    private onClientLeaveRoom;
    registerHandler(name: string, klass: Function, options?: any): RegisteredHandler;
